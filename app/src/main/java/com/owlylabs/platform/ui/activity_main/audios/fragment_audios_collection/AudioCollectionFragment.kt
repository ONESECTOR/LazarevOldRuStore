package com.owlylabs.platform.ui.audios.fragment_audios_collection
...
import com.owlylabs.platform.ui.audios.fragment_audios_collection.audio_list.AudioCollectionRecyclerViewAdapter
import com.owlylabs.platform.ui.audios.fragment_audios_collection.audio_list.AudioCollectionRecyclerViewItemDecoration
...
class AudioCollectionFragment : DaggerFragment() {
    ...
    private lateinit var viewModel: AudioCollectionViewModel

    private lateinit var appBarLayout: AppBarLayout
    private lateinit var materialToolbar: MaterialToolbar
    private lateinit var collapsing_toolbar: CollapsingToolbarLayout
    private lateinit var recyclerView: RecyclerView
    protected lateinit var recyclerViewAdapter: AudioCollectionRecyclerViewAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(
            this,
            AudioCollectionViewModel.Factory(
                repository,
                sectionId
            )
        ).get(sectionId.toString(), AudioCollectionViewModel::class.java)
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_audio_collection, container, false)
    }
    ...
    override fun onStart() {
        super.onStart()
        viewModel.sectionData.observe(this, Observer { tabData ->
    ...
    private fun configRecyclerView() {
        recyclerViewAdapter =
            AudioCollectionRecyclerViewAdapter(
        ...
        gridLayoutManager.setSpanSizeLookup(object : GridLayoutManager.SpanSizeLookup() {
            override fun getSpanSize(position: Int): Int {
                return when (recyclerViewAdapter.getItemViewType(position)) {
                    AppLogicConstants.AudioCollectionViewHolderType.AUDIO.ordinal -> resources.getInteger(R.integer.numberOfBookCollectionBookHolder)
                    AppLogicConstants.AudioCollectionViewHolderType.SUBTITLE.ordinal -> resources.getInteger(R.integer.numberOfBookCollectionDescription)
        ...
        recyclerView.addItemDecoration(
            AudioCollectionRecyclerViewItemDecoration(
                mContext
            )
        )
