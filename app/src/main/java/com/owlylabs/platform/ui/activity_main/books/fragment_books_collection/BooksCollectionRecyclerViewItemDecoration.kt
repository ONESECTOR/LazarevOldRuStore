...
class BooksCollectionRecyclerViewItemDecoration(context: Context): RecyclerView.ItemDecoration() {
    ...
    override fun getItemOffsets(
        ...
        when (itemHolder){
            is BooksCollectionRecyclerViewAdapter.BookHolder -> {
            ...
            is BooksCollectionRecyclerViewAdapter.SubTitleHolder -> {
                outRect.top = 0
                outRect.left = 0
                outRect.right = 0
                outRect.bottom = 0
